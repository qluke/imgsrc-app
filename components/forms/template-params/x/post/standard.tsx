// components/forms/template-params/x/post/standard.tsx
...
export function Form() {
  ...
  const params = template.params as StandardTemplate["params"]
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Customize your post by changing the properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>
