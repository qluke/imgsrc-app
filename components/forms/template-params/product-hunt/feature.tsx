// components/forms/template-params/product-hunt/feature.tsx
import { useTemplateStore } from "@/providers/template-store-provider"
import { MixerHorizontalIcon } from "@radix-ui/react-icons"

import { FeatureTemplate } from "@/lib/templates/product-hunt"
...
export function Form() {
  ...
  const params = template.params as FeatureTemplate["params"]
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Customize your Product Hunt feature by changing the properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>
              ...
              <div className="flex space-x-2">
                ...
                >
                  <TextSettings
                    ...
                    color={params.title?.color || "#111827"}
