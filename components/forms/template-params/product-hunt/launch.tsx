// components/forms/template-params/product-hunt/launch.tsx
...
export function Form() {
  ...
  const params = template.params as LaunchTemplate["params"]
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Customize your Product Hunt launch by changing the properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>
          <div className="grid w-full items-center gap-4">
            <div className="flex flex-col space-y-1.5">
              ...
              <div className="flex space-x-2">
                ...
                <ResponsivePopover
                  title="Font Settings"
                  description="Customize the tagline font."
                  trigger={
                ...
                >
                  <TextSettings
                    fontFamily={params.tagline?.fontFamily || "inter"}
                    fontSize={params.tagline?.fontSize || 20}
                    fontWeight={params.tagline?.fontWeight || 600}
                    color={params.tagline?.color || "#111827"}
              ...
              <div className="flex space-x-2">
                ...
                >
                  <TextSettings
                    ...
                    color={params.title?.color || "#da552f"}
                    onChangeFontFamily={(fontFamily) =>
                      template.updateParams({
                        title: {
                          ...params.title,
              ...
              <div className="flex space-x-2">
                ...
                >
                  <TextSettings
                    ...
                    fontWeight={params.description?.fontWeight || 500}
