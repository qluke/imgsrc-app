// components/forms/template-params/facebook/post-promotion.tsx
...
export function Form() {
  ...
  const params = template.params as PostPromotionTemplate["params"]
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Customize your promotional post by changing the properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>
