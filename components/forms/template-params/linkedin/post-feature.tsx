// components/forms/template-params/linkedin/post-feature.tsx
...
export function Form() {
  ...
  const params = template.params as PostFeatureTemplate["params"]
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Customize your LinkedIn feature post by changing the properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>
          <div className="grid w-full items-center gap-4">
              ...
              <div className="flex space-x-2">
                ...
                >
                  <TextSettings
                    ...
                    fontSize={params.title?.fontSize || 44}
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <Input
                id="button-bg"
                value={params.button?.background || "#0a66c2"}
                type="color"
                onChange={(e) =>
                  template.updateParams({
                    button: {
