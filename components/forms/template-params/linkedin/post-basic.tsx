// components/forms/template-params/linkedin/post-basic.tsx
...
export function Form() {
  ...
  const params = template.params as PostBasicTemplate["params"]
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Customize your LinkedIn post by changing the properties.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form>
