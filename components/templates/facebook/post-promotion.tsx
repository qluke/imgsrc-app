// components/templates/facebook/post-promotion.tsx
import { patterns } from "@/lib/patterns"
import { toBackgroundShorthand } from "@/lib/templates/elements/background"
import { PostPromotionTemplate } from "@/lib/templates/facebook"
...
export const Template = ({
  ...
  template: PostPromotionTemplate
  ...
  >
    ...
    >
      ...
      {template.params.button?.text && (
        <div
          style={{
            display: "inline-block",
            fontFamily: template.params.button.fontFamily,
            fontWeight: template.params.button.fontWeight,
            fontSize: `${template.params.button.fontSize}px`,
            color: template.params.button.color,
            background: template.params.button.background,
